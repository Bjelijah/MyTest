package com.netease.live.server;
...
//import com.netease.live.activity.EnterAudienceActivity;
import com.netease.live.config.DemoServers;
import com.netease.live.server.entity.AddVideoResponseEntity;
import com.netease.live.server.entity.RoomInfoEntity;
import com.netease.live.server.entity.TranscodeResponseEntity;
import com.netease.live.server.entity.VideoInfoEntity;
import com.netease.live.util.sys.AndTools;
...
public class DemoServerHttpClient {
    ...
    public void getRoomInfo(int mode, String address, final DemoServerHttpCallback<RoomInfoEntity> callback){
        ...
        StringBuilder body = new StringBuilder();
        body.append(REQUEST_SID).append("=").append(DemoCache.getSid()).append("&");
//        if(mode == EnterAudienceActivity.MODE_ROOM){//FIXME  cbj
