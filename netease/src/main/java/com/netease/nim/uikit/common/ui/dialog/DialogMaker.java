...
public class DialogMaker {
	...
	public static EasyProgressDialog showProgressDialog(Context context, String message, OnCancelListener listener){
		return showProgressDialog(context, null, message, true, listener);
	}
