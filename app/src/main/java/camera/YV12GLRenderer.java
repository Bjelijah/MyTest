...
public class YV12GLRenderer implements GLViewRenderer {
    ...
    private GLTextureView gl_texture_view_;
...
//		}
    ...
    public YV12GLRenderer(Context context, GLTextureView view, Handler handler) {
        Log.e("123","YV12GLRenderer");
        context_ = context;
    ...
    public void requestRender() {
        Log.e("123","native invoke render ");
