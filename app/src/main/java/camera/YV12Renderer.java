...
public class
YV12Renderer implements Renderer {
...
//		}
	...
	public YV12Renderer(Context context, GLTextureView view, Handler handler) {
		context_ = context;
	...
	public void requestRender() {
		...
		if(gl_surface_view_!=null){gl_surface_view_.requestRender();return;}
