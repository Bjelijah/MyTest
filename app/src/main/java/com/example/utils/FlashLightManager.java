...
public class FlashLightManager {
    ...
    public void ctrlLamp(boolean isOpen) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        // save methods
        Method getFlashlightEnabled = proxy.getMethod("getFlashlightEnabled");
        Method setFlashlightEnabled = proxy.getMethod("setFlashlightEnabled",
                boolean.class);
        setFlashlightEnabled.invoke(svc, isOpen);
    }
